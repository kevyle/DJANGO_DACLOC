...
class Account(models.Model):
    username = models.CharField(max_length=28, default='Anonymous', blank=True, unique=True)
    display_name = models.CharField(max_length=28, default='Anonymous', blank=True, unique=False)
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f'Comment by {self.author.username} on Post {self.post.id}' or "No Content"